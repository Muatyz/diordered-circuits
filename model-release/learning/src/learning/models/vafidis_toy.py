...
def step_vafidis_toy(
    *,
    ...
    ``validate_state=False`` is reserved for the interior microsteps of a
    multirate block. The block driver validates the complete state after its
    accumulated plasticity update. It also sets
