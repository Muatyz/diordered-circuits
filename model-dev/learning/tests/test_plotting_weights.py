...
def test_snapshot_pi_development_plot_accepts_zero_and_log_times(
    ...
    plot_weight_snapshot_pi_development(
        ...
        maximum_abs_velocity_bias=np.asarray([0.12, 0.03, 0.06]),
        depinning_velocity=np.asarray([0.5, 0.1, np.inf]),
        snapshot_acceptance_passed=np.asarray([0.0, 1.0, 0.0]),
        selection_was_fallback=False,
